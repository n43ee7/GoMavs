...
#
# Notes:
#   > Add the XPath parameters on line 157 and 159 before executing.
#
#   > If the existing formatting of the Website RETIRES please re-adjust the Xpath locations according to the comments.
#   > Precautionary delays are removed for swifter operation.
#
#   ================================================Disclaimer [!]======================================================
...
time.sleep(0.01)
win32api.keybd_event(0x7A, 0, 0, 0)  # holds the F11 key down for full-screen
time.sleep(0.01)
...
# For the automation to occur I decided to use X-Paths and sometimes element ID from the Website(s) for script to navigate through.
...
# webrequesthandler('', 1, "")                                                                                          # Add Xpath to the 'Accept' button on the portal
# Iteration to ensure popup is opened
# webrequesthandler('', 1, "")                                                                                          # Add Xpath to the 'Yes' before compiling
time.sleep(30)
